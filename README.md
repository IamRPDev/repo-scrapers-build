...
This repository is a dedicated **Builder** for the **Scrapers** component of the Kodi ecosystem. 
...
|:---|:---:|:---|
| Linux 64 | [![Build Status](https://github.com/IamRPDev/repo-scrapers-build/actions/workflows/build.yml/badge.svg)](https://github.com/IamRPDev/repo-scrapers-build/actions) | [repo-scrapers-build-linux64](https://github.com/IamRPDev/repo-scrapers-build-linux64) |
